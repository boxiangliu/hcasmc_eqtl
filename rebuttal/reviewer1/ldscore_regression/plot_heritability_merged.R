...
# Variables:
partition_heritability_dir='../processed_data/rebuttal/reviewer1/ldscore_regression/partition_heritability_merged/'
fig_dir='../figures/rebuttal/reviewer1/ldscore_regression/plot_heritability_merged/'
