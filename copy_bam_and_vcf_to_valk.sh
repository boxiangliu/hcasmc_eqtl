...
while read dir; do
	...
	if [[ $dir != "joint/" ]]; then
		...
		rsync -vzh --progress /mnt/data/WGS_HCASMC/$dir/{raw_variants.g.vcf.gz,raw_variants.g.vcf.gz.tbi,realignment_targets.list,recal_data.table,recal_reads.bai,recal_reads.bam} bosh@valkyr.stanford.edu:/home/diskstation/wgs/WGS_HCASMC2/$dir/
	...
	if [[ $dir == "joint/" ]]; then
		...
		rsync -vzh --progress /mnt/data/WGS_HCASMC/$dir/{raw_variants.vcf,raw_variants.vcf.idx,recalibrated_variants.vcf.gz,recalibrated_variants.vcf.gz.tbi} bosh@valkyr.stanford.edu:/home/diskstation/wgs/WGS_HCASMC2/$dir/
