...
# Variables:
partition_heritability_dir='../processed_data/gwas_gene_overlap/ldscore_regression/partition_heritability_merged_ukbb/'
fig_dir='../figures/gwas_gene_overlap/ldscore_regression/plot_heritability_merged_ukbb/'
