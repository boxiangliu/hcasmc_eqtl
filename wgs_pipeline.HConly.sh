...
rm raw_variants.g.vcf
java -Xmx24g -jar $gatk -T HaplotypeCaller -nct 8 -R $hg19 -I recal_reads.bam --genotyping_mode DISCOVERY --emitRefConfidence GVCF -o raw_variants.g.vcf 2>/srv/persistent/bliu2/HCASMC_eQTL/scripts/wgs_pipeline.HConly/$sample.log
