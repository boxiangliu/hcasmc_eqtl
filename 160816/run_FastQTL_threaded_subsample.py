...
def get_cmd(args, chunk):
    ...
    cmd = fastqtl_dir + ' --vcf '+args.vcf+' --bed '+args.bed+' --window '+args.window\
        +' --maf-threshold '+args.maf_threshold+' --ma-sample-threshold '+args.ma_sample_threshold
    if args.covariates:
...
parser.add_argument('--include_samples', default = '', help = 'List of samples to include in the analysis')
...
with cd(args.output_dir):
    ...
    if args.permute:
        ...
        cmd = 'Rscript /users/joed3/GTExCisEqtls/code/fastqtl/R/calculateSignificanceFastQTL.R'\
