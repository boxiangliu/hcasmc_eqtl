...
# command args:
figure_path='../figures/eqtl/fastqtl/find_optimum_num_PEER_factors/num_egene_vs_cov.pdf'


# list input files:
input_files=list.files(path='../processed_data/eqtl/fastqtl/find_optimum_num_PEER_factors/',pattern='padj.txt',full.names=T)
